...
<head>
     ...
     <meta name="description"
          content="Cuda An Awesome Single Page Portfolio Html Template. You Can Easily Design Your Portfolio Website Using This Template.">
     ...
     <!-- FONT AWESOME-->
     <script src="https://kit.fontawesome.com/15f9886610.js" crossorigin="anonymous"></script>
     <!-- VENDORS FILES-->
...
<body>
     ...
     <header id="home">
          <nav>
               <div class="row">
                    <a href="#home">
                         <img src="images/logo.png" alt="cuda" class="logo">
                    </a>
          ...
          <div class="row">
               ...
               <div class="row">
                    <div class="col span_1_of_4 box">
                         <img src="images/flag.png" alt="flag" class="services-icon">
                         <h3>Branding</h3>
                         <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh.</p>
                    </div>

                    <div class="col span_1_of_4 box">
                         <img src="images/crayonicon.png" alt="crayon" class="services-icon">
                         <h3>Design</h3>
                         <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem lorem ipsum </p>
                    </div>

                    <div class="col span_1_of_4 box">
                         <img src="images/gearsicon.png" alt="gears" class="services-icon">
                         <h3>Development</h3>
                         <p>At vero eos et accusamus et iusto odio dignissimos qui blanditiis praesentium.</p>
                    </div>

                    <div class="col span_1_of_4 box">
                         <img src="images/rocketicon.png" alt="rocket" class="services-icon">
     ...
     <section class=" team-section" id="team">
          <div class="row">
               ...
               <p class="little-descriptioon"> We are a small team of designers and developers, who help brands with big
                    ideas.</p>
          </div>

          <div class="row">
               <div class="col span_1_of_4 box">
                    <img src="resources/images/1.jpeg" alt="ANNE HATHAWAY" class="team-member">
                    ...
                    <div class="social-link">
                         <ul>
                              <li><a href="https://www.facebook.com/Naiem.Yt"> <i class="fab fa-facebook-f"></i> </a>
                              </li>
               ...
               <div class="col span_1_of_4 box">
                    <img src="resources/images/2.jpeg" alt="Kate Upton" class="team-member">
               ...
               <div class="col span_1_of_4 box">
                    <img src="resources/images/3.jpeg" alt="Olivia Wilde" class="team-member">

                    <h3>Olivia Wilde</h3>
                    <span class="role">Lead Designer</span>
                    <p>Nemo enim ipsam voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores
                         eos qui ratione
               ...
               <div class="col span_1_of_4 box">
                    <img src="resources/images/4.jpeg" alt="Ashley Greene" class="team-member">
     ...
     <section class="portfolio-section" id="portfolio">
          ...
          <div class="row container">
               <div class="col span_1_of_2 mix app box">
                    <img src="images/portfolio1.png" alt="Isometric Perspective Mock-Up" class="portfolio-images">
                    <h4> Isometric Perspective Mock-Up</h4>
               </div>


               <div class="col span_1_of_2 mix app web box">
                    <img src="images/portfolio2.png" alt="Time Zone App UI" class="portfolio-images">
                    <h4> Time Zone App UI</h4>
               </div>

               <div class="col span_1_of_2 mix icons box">
                    <img src="images/portfolio3.png" alt="Viro Media Players UI" class="portfolio-images">
                    <h4> Viro Media Players UI</h4>
               </div>

               <div class="col span_1_of_2 mix icons web apps box">
                    <img src="images/portfolio4.png" alt="Blog / Magazine Flat UI Kit" class="portfolio-images">
               ...
               <div class="row">
                    <div class="col span_1_of_2 box">
                         <div class="client-photo">
                              <img src="resources/images/1.jpeg" alt="Chanel Iman">
                         </div>

                         <div class="client-review">
                              <p>“Nullam dapibus blandit orci, viverra gravida dui lobortis eget. Maecenas fringilla
                                   urna eu nisl scelerisque.” </p>
                              <h3>Chanel Iman</h3>
                              <span class="role">
                                   CEO of Pinterest
                              </span>
                    ...
                    <div class="col span_1_of_2 box">
                         <div class="client-photo">
                              <img src="resources/images/2.jpeg" alt="Chanel Iman">
                         </div>

                         <div class="client-review">
                              <p>“Vivamus luctus urna sed urna ultricies ac tempor dui sagittis. In condimentum
                                   facilisis porta.” </p>
                              <h3>ADRIANA LIMA</h3>
                              <span class="role">
                    ...
                    <div class="col span_1_of_2 box">
                         <div class="client-photo">
                              <img src="resources/images/3.jpeg" alt="Chanel Iman">
                         </div>
                    ...
                    <div class="col span_1_of_2 box">
                         ...
                         <div class="client-review">
                              <p>“Phasellus non purus vel arcu tempor commodo. Fusce semper, purus vel luctus molestie,
                                   risus sem cursus neque.”</p>
                              <h3>EMMA STONE</h3>
                              <span class="role">
     ...
     <section class="contact-section" id="contact">
          ...
          <div class="row">
               <form action="https://formspree.io/f/mvovlppd" method="POST">
                    <div class="row">
